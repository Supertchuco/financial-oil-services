...
public class FinancialOilServicesIntegrationTest {
    ...
    public void shouldReturn200AndOilRegistryWhenGetOilRegistryByIdWithSuccess() {
        ...
        final String result = "{\"oilId\":\"TIM\",\"oilType\":{\"oilType\":\"Premium\",\"description\":\"Premium type\"},\"fixedRevenue\":5,"
                + "\"variableRevenue\":7,\"oilBarrelValue\":111.00}";
    ...
    public void shouldReturn200AndOilRegistriesWhenGetAllOilRegistriesWithSuccess() {
        ...
        final String result = "[{\"oilId\":\"AAC\",\"oilType\":{\"oilType\":\"Standard\",\"description\":\"Standard type\"},\"fixedRevenue\":1,"
                ...
                + "\"description\":\"Standard type\"},\"fixedRevenue\":7,\"variableRevenue\":null,\"oilBarrelValue\":47.00},"
                + "{\"oilId\":\"BWO\",\"oilType\":{\"oilType\":\"Standard\",\"description\":\"Standard type\"},\"fixedRevenue\":17,"
                + "\"variableRevenue\":null,\"oilBarrelValue\":61.00},{\"oilId\":\"TIM\","
                + "\"oilType\":{\"oilType\":\"Premium\",\"description\":\"Premium type\"},\"fixedRevenue\":5,\"variableRevenue\":7,"
                + "\"oilBarrelValue\":111.00},{\"oilId\":\"QFC\",\"oilType\":{\"oilType\":\"Standard\",\"description\":\"Standard type\"},"
                + "\"fixedRevenue\":22,\"variableRevenue\":null,\"oilBarrelValue\":123.00}]";
        assertTrue(response.getBody().contains(result));
    }
    ...
    public void shouldReturn200AndOilRegistryWhenGetOilTransactionRegistryByIdWithSuccess() {
        ...
        final String result = "{\"transactionId\":99,\"volume\":11,\"price\":50.25,\"operation\":\"Buy\",\"oil\":{\"oilId\":\"REW\","
                + "\"oilType\":{\"oilType\":\"Standard\",\"description\":\"Standard type\"},\"fixedRevenue\":7,\"variableRevenue\":null,"
                + "\"oilBarrelValue\":47.00},\"transactionDateTime\":\"2020-01-12T22:37:06.691\"}";
        assertTrue(response.getBody().contains(result));
    }
    ...
    public void shouldReturn200AndOilRegistriesWhenGetAllOilTransactionRegistriesWithSuccess() {
        ...
        final String result = "{\"transactionId\":90,\"volume\":11,\"price\":48.25,\"operation\":\"Sell\",\"oil\":{\"oilId\":\"BWO\","
                + "\"oilType\":{\"oilType\":\"Standard\",\"description\":\"Standard type\"},\"fixedRevenue\":17,\"variableRevenue\":null,"
                + "\"oilBarrelValue\":61.00},\"transactionDateTime\":\"2020-01-12T22:37:06.691\"},{\"transactionId\":99,\"volume\":11,"
                + "\"price\":50.25,\"operation\":\"Buy\",\"oil\":{\"oilId\":\"REW\",\"oilType\":{\"oilType\":\"Standard\","
                + "\"description\":\"Standard type\"},\"fixedRevenue\":7,\"variableRevenue\":null,\"oilBarrelValue\":47.00},"
                + "\"transactionDateTime\":\"2020-01-12T22:37:06.691\"}";
        assertTrue(response.getBody().contains(result));
    }
