...
public class OilTransactionServiceTest {
    ...
    public void shouldPersistOilTransactionOnDatabaseWithSuccess() {
        ...
        inputArray = new Object[]{new InputOilTransactionDto(Operations.BUY.name(), 10, BigDecimal.valueOf(5), OIL_ID_TEST)};
    ...
    public void shouldExecuteOilTransactionOperationWithSuccess() {
        ...
        doReturn(new OilTransaction(1, 10, BigDecimal.valueOf(19.50), Operations.BUY.name(), oil, null))
                .when(oilTransactionRepository).save(any(OilTransaction.class));
        ...
        doReturn(BigDecimal.valueOf(5.05)).when(statisticsService).calculatePriceEarningsRatio(Mockito.any(BigDecimal.class),
                Mockito.any(Integer.class));
        assertNotNull(oilTransactionService.oilTransactionOperation(new InputOilTransactionDto(Operations.BUY.name(), 10, BigDecimal.valueOf(5),
                OIL_ID_TEST)));
    }
    ...
    public void shouldThrowInvalidOperationExceptionWhenOperationIsInvalidInRequestBodyDuringPersistOilTransactionOnDatabase() {
        doReturn(buildOilObject()).when(oilRepository).findByOilId(anyString());
        oilTransactionService.oilTransactionOperation(new InputOilTransactionDto("INVALID OPERATION", 10, BigDecimal.valueOf(5),
                OIL_ID_TEST));
    }
    ...
    private Oil buildOilObject() {
        return new Oil(OIL_ID_TEST, new OilType("TypeTest", "TypeTest"), 1, BigDecimal.valueOf(19.50));
    }
}
